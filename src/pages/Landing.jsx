  ...
  return (
    <div style={{ fontFamily:'var(--font-body)', overflowX:'hidden' }}>
      ...
      <section style={{ minHeight:'100vh', display:'flex', alignItems:'flex-end', padding:'10rem 5% 6rem', position:'relative', overflow:'hidden' }}>
        {/* Fondo a Color */}
        <div style={{ position:'absolute', inset:0, zIndex:0, backgroundImage:'url("/hero_IMG_5386.jpg")', backgroundSize:'cover', backgroundPosition:'center 22%', pointerEvents:'none' }} />
